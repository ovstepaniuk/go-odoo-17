...
type HrLeave struct {
	...
	AllEmployeeIds              *Relation  `xmlrpc:"all_employee_ids,omitempty"`
	...
	IsUserOnlyResponsible       *Bool      `xmlrpc:"is_user_only_responsible,omitempty"`
	L10NFrDateToChanged         *Bool      `xmlrpc:"l10n_fr_date_to_changed,omitempty"`
	...
	NumberOfHoursText           *String    `xmlrpc:"number_of_hours_text,omitempty"`
