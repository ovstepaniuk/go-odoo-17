...
func (c *Client) CreateResUsersApikeysDescription(ruad *ResUsersApikeysDescription) (int64, error) {
	ids, err := c.CreateResUsersApikeysDescriptions([]*ResUsersApikeysDescription{ruad})
	if err != nil {
		return -1, err
	}
	if len(ids) == 0 {
...
// CreateResUsersApikeysDescription creates a new res.users.apikeys.description model and returns its id.
func (c *Client) CreateResUsersApikeysDescriptions(ruads []*ResUsersApikeysDescription) ([]int64, error) {
	var vv []interface{}
	for _, v := range ruads {
		vv = append(vv, v)
	}
	return c.Create(ResUsersApikeysDescriptionModel, vv, nil)
}
...
func (c *Client) UpdateResUsersApikeysDescriptions(ids []int64, ruad *ResUsersApikeysDescription) error {
	return c.Update(ResUsersApikeysDescriptionModel, ids, ruad, nil)
}
...
func (c *Client) FindResUsersApikeysDescriptionIds(criteria *Criteria, options *Options) ([]int64, error) {
	return c.Search(ResUsersApikeysDescriptionModel, criteria, options)
}
